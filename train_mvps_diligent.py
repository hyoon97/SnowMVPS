...
parser.add_argument('--trainpath', default='/ssd4/seongmin/DB/DiLiGenT-MV/mvpmsData', help='train datapath')
parser.add_argument('--testpath', default='/ssd4/seongmin/DB/DiLiGenT-MV/mvpmsData', help='testing data dir for some scenes')
parser.add_argument('--trainlist', default='lists/diligent_mv/test.txt', help='testing scene list')
...
parser.add_argument('--loadckpt', default='checkpoints/mvsp-attention1/finalmodel.ckpt', help='load a specific checkpoint')
...
if __name__ == '__main__':
    ...
    elif args.dataset.startswith('general_eval4_diligent'):
        train_dataset = MVSDataset(args.trainpath, "train", nviews=args.n_views, nlights=3)
        test_dataset = MVSDataset(args.testpath, "test", nviews=args.n_views, nlights=3)
