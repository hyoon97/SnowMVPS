...
def save_scene_depth(testlist):
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            for filename, cam, img, depth_est, mvs_normal_est, photometric_confidence, weight, vals in zip(filenames, cams, imgs,  \
